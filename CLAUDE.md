...
- **AGENT-APPROVE-\*** — Agent approve endpoint contract issues. AGENT-APPROVE-001a: concurrent race guard (CAS fix); closed 2026-06-03. AGENT-APPROVE-001b: approve blocks on synchronous execution, exceeds client timeout on slow tools; open.

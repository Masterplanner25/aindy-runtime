...
- Current chain: `0001` → … → `0010` → `0011` (effect-record attribution, MEB) → `0012`
  ...
  (`0014_users_email_verification`, FR-6/FR-8) → **`0015`** (`0015_agents_metadata`, FR-13). *Corrected 2026-08-14: this line said the

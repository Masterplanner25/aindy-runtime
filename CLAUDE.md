...
- **C2, C3** — cross-platform sandbox tiers. C2: container-grade, closed 2026-05-24. C3: strong-sandbox cross-platform; Phase 0 (adversarial escape test suite — 17 tests in `tests/sandbox/`, marker `sandbox_escape`, artifact `tests/sandbox/sandbox_escape_results.json`) complete 2026-06-04; Phase 1 (`_detect_wsl2()`, Linux backend propagation to OCI controls, 21 new unit tests) complete 2026-06-06; Phase 3 (threat model `docs/runtime/SANDBOX_ESCAPE_AUDIT.md` + `sandbox_escape_test_posture()` in `sandbox_runner.py`) complete 2026-06-05; Phase 4 (release gate Step 16 in `docs/runtime/RELEASE_CHECKLIST.md`) complete 2026-06-05; Phase 2 (macOS Docker Desktop policy) open.

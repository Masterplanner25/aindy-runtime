...
| **FR-35 guest-path LLM usage design — usage rides the worker reply; deferral replaces observation in the worker; admission vs accounting (§3)** | `docs/design/FR35_GUEST_LLM_USAGE_DESIGN.md` |

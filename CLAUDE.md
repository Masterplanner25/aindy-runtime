...
| Latest app-team handoff | `docs/runtime/APP_HANDOFF_v2.7.0.md` — **is** a plain `pip install` (no schema step, no migration, no flag flips); §1 is the scheduler dispatch flip and why it is a NO-OP on the prod overlay, §2 is three security fixes in `nodus-lang` 5.9.0 |
